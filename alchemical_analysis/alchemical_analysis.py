...
def estimatewithMBAR(u_kln, N_k, reltol, regular_estimate=False):
   ...
   def plotOverlapMatrix(O):
      ...
      pl.annotate(r'$\lambda$', xy=(-0.5, K-(j+0.5)), xytext=(-0.5, K+0.5), size=10, textcoords=('data', 'data'), va='center', ha='center', color='k')
...
def dF_t():
   ...
   def plotdFvsTime(f_ts, r_ts, F_df, R_df, F_ddf, R_ddf):
      ...
      pl.ylabel(r'$\Delta G$ '+P.units, fontsize=16, color='#151B54')
...
def plotdFvsLambda():
   ...
   def plotdFvsLambda1():
      ...
      pl.ylabel(r'$\Delta G$ '+P.units, fontsize=12, color='#151B54')
